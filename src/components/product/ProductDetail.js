...
export default function ProductDetail () {
    ...
    useEffect(()=>{
        ...
        if(!product._id || isReviewSubmitted) {
         ...
         let isCartExist;
    useEffect(()=>{
         isCartExist=items.find((i)=>i.product===product._id)
            ...
            <Fragment>
                ...
                <div className="row f-flex justify-content-around">
                    ...
                    <button type="button" id="cart_btn" 
                     disabled={product.stock===0?true:false && isCartExist ? true:false  } 
                ...
                {
                    product.reviews && product.reviews.length?<ProductReview reviews={product.reviews}/>:null
                }
            </Fragment>}
        </Fragment>
    )
